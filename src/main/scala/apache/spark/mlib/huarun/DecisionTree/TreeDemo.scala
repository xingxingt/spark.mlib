package apache.spark.mlib.huarun.DecisionTree
...
object TreeDemo {
  /**
    * https://blog.csdn.net/kwu_ganymede/article/details/52040392
    * @param args
    */
  ...
  def main(args: Array[String]) {
    ...
    //训练数据
    val data1 = sc.textFile("data/descision_tree1.txt")

    //测试数据
    val data2 = sc.textFile("data/descision_tree2.txt")
